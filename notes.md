...
- <u>infrastructure (hardware)</u>
- <u>networking (node discovery, information propagation and verification)</u>
- <u>consensus (proof of work, proof of stake)</u>
- <u>data (blocks, transactions)</u>
- <u>application (smart contracts/dApps, if applicable)</u>
